<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="contact-request.aspx.cs" Inherits="Admin_view_contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="msgModalLabel">Message from <span id="modalSenderName"></span></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8" id="mdPhone"></div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div id="mdMessage"
                                 style="white-space: pre-wrap; background:#f8f9fa;
                                        ...
                                        padding:14px; min-height:80px; font-size:14px;
                                        line-height:1.7;">
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/pages/contact-request.js"></script>
