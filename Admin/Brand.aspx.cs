...
public partial class Admin_Brand : System.Web.UI.Page
{
    ...
    public string strBrands = "", strBannerImage = "", strMobileImage = "";
    ...
    private void GetAllBrands()
    {
        ...
        {
            strBrands = "";
            var list = Brand.GetAllBrand(conT);
            int i = 0;
    ...
    private void GetBrand()
    {
        try
        {
            var cat = Brand.GetAllBrand(conT)
            ...
            if (cat != null)
            {
                btnSave.Text = "Update";
                btnNew.Visible = true;
                txtCategory.Text = cat.BrandName;
                txtUrl.Text = cat.BrandUrl;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ind1 == "Size") { ShowError("Thumb image size should be 263px × 140px"); return; }
            ...
            Brand cat = new Brand();
            cat.BrandName = txtCategory.Text.Trim();
            cat.BrandUrl = txtUrl.Text.Trim();
            ...
            if (btnSave.Text == "Update")
            {
                ...
                int result = Brand.UpdateBrand(conT, cat);
                if (result > 0)
                {
                    GetBrand();
                    GetAllBrands();
            ...
            {
                int result = Brand.InsertBrand(conT, cat);
                if (result > 0)
                {
    ...
    public static string Delete(string id)
    {
        try
        {
            ...
            int result = Brand.DeleteBrand(conT, cat);
    ...
    private string UploadThumbImage()
    {
        ...
        if (fuIndSamll.HasFile)
        {
            ...
            string savePath = Server.MapPath("~/UploadImages/") + guid + "_BrandThumb" + ext;
            ...
            else
            {
                ...
                if (bmp.Width != 263 || bmp.Height != 140) return "Size";
            ...
            thumbImage = "UploadImages/" + guid + "_BrandThumb" + ext;
        }
        else
        {
    ...
    private string UploadMobileImage()
    {
        ...
        if (fuIndThumb.HasFile)
        {
            ...
            string guid = Guid.NewGuid().ToString();
            string savePath = Server.MapPath("~/UploadImages/") + guid + "_BrandMobile" + ext;
            ...
            mobileImage = "UploadImages/" + guid + "_BrandMobile" + ext;
        }
        else
        {
