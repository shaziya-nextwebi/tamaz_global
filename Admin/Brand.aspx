<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Brand.aspx.cs" Inherits="Admin_Brand" ValidateRequest="false" %>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><%=Request.QueryString["id"] != null ? "Update" : "Add New" %> Brand</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/Admin/">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Master Settings</a></li>
                                <li class="breadcrumb-item active"><%=Request.QueryString["id"] != null ? "Update" : "Add" %> Brand</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label">Brand Name <sup>*</sup></label>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label">Brand URL <sup>*</sup></label>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label">Brand Order</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <small class="text-danger">.png .jpeg .jpg .gif .webp — 263px × 140px</small>
