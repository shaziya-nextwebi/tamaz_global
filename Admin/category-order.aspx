        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Re-Arrange Category Display Order</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Re-Arrange Category Display Order by Category</h5>
                </div>
                <div class="card-body">
