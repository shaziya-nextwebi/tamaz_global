...
type EventTypsq_d_ExecCommandEvent = ExecCommandEvent;
type EventTypsq_d_BeforeGetContentEvent = BeforeGetContentEvent;
type EventTypsq_d_GetContentEvent = GetContentEvent;
type EventTypsq_d_BeforeSetContentEvent = BeforeSetContentEvent;
type EventTypsq_d_SetContentEvent = SetContentEvent;
type EventTypsq_d_SaveContentEvent = SaveContentEvent;
type EventTypsq_d_NewBlockEvent = NewBlockEvent;
type EventTypsq_d_NodeChangeEvent = NodeChangeEvent;
type EventTypsq_d_FormatEvent = FormatEvent;
type EventTypsq_d_ObjectResizeEvent = ObjectResizeEvent;
type EventTypsq_d_ObjectSelectedEvent = ObjectSelectedEvent;
type EventTypsq_d_ScrollIntoViewEvent = ScrollIntoViewEvent;
type EventTypsq_d_SetSelectionRangeEvent = SetSelectionRangeEvent;
type EventTypsq_d_ShowCaretEvent = ShowCaretEvent;
type EventTypsq_d_SwitchModeEvent = SwitchModeEvent;
type EventTypsq_d_ChangeEvent = ChangeEvent;
type EventTypsq_d_AddUndoEvent = AddUndoEvent;
type EventTypsq_d_UndoRedoEvent = UndoRedoEvent;
type EventTypsq_d_WindowEvent<T extends DialogData> = WindowEvent<T>;
type EventTypsq_d_ProgressStateEvent = ProgressStateEvent;
type EventTypsq_d_AfterProgressStateEvent = AfterProgressStateEvent;
type EventTypsq_d_PlaceholderToggleEvent = PlaceholderToggleEvent;
type EventTypsq_d_LoadErrorEvent = LoadErrorEvent;
type EventTypsq_d_PreProcessEvent = PreProcessEvent;
type EventTypsq_d_PostProcessEvent = PostProcessEvent;
type EventTypsq_d_PastePlainTextToggleEvent = PastePlainTextToggleEvent;
type EventTypsq_d_PastePreProcessEvent = PastePreProcessEvent;
type EventTypsq_d_PastePostProcessEvent = PastePostProcessEvent;
type EventTypsq_d_NewTableRowEvent = NewTableRowEvent;
type EventTypsq_d_NewTableCellEvent = NewTableCellEvent;
type EventTypsq_d_TableEventData = TableEventData;
type EventTypsq_d_TableModifiedEvent = TableModifiedEvent;
type EventTypsq_d_BeforeOpenNotificationEvent = BeforeOpenNotificationEvent;
type EventTypsq_d_OpenNotificationEvent = OpenNotificationEvent;
type EventTypsq_d_EditorEventMap = EditorEventMap;
type EventTypsq_d_EditorManagerEventMap = EditorManagerEventMap;
declare namespace EventTypsq_d {
    export { EventTypsq_d_ExecCommandEvent as ExecCommandEvent, EventTypsq_d_BeforeGetContentEvent as BeforeGetContentEvent, EventTypsq_d_GetContentEvent as GetContentEvent, EventTypsq_d_BeforeSetContentEvent as BeforeSetContentEvent, EventTypsq_d_SetContentEvent as SetContentEvent, EventTypsq_d_SaveContentEvent as SaveContentEvent, EventTypsq_d_NewBlockEvent as NewBlockEvent, EventTypsq_d_NodeChangeEvent as NodeChangeEvent, EventTypsq_d_FormatEvent as FormatEvent, EventTypsq_d_ObjectResizeEvent as ObjectResizeEvent, EventTypsq_d_ObjectSelectedEvent as ObjectSelectedEvent, EventTypsq_d_ScrollIntoViewEvent as ScrollIntoViewEvent, EventTypsq_d_SetSelectionRangeEvent as SetSelectionRangeEvent, EventTypsq_d_ShowCaretEvent as ShowCaretEvent, EventTypsq_d_SwitchModeEvent as SwitchModeEvent, EventTypsq_d_ChangeEvent as ChangeEvent, EventTypsq_d_AddUndoEvent as AddUndoEvent, EventTypsq_d_UndoRedoEvent as UndoRedoEvent, EventTypsq_d_WindowEvent as WindowEvent, EventTypsq_d_ProgressStateEvent as ProgressStateEvent, EventTypsq_d_AfterProgressStateEvent as AfterProgressStateEvent, EventTypsq_d_PlaceholderToggleEvent as PlaceholderToggleEvent, EventTypsq_d_LoadErrorEvent as LoadErrorEvent, EventTypsq_d_PreProcessEvent as PreProcessEvent, EventTypsq_d_PostProcessEvent as PostProcessEvent, EventTypsq_d_PastePlainTextToggleEvent as PastePlainTextToggleEvent, EventTypsq_d_PastePreProcessEvent as PastePreProcessEvent, EventTypsq_d_PastePostProcessEvent as PastePostProcessEvent, EventTypsq_d_NewTableRowEvent as NewTableRowEvent, EventTypsq_d_NewTableCellEvent as NewTableCellEvent, EventTypsq_d_TableEventData as TableEventData, EventTypsq_d_TableModifiedEvent as TableModifiedEvent, EventTypsq_d_BeforeOpenNotificationEvent as BeforeOpenNotificationEvent, EventTypsq_d_OpenNotificationEvent as OpenNotificationEvent, EventTypsq_d_EditorEventMap as EditorEventMap, EventTypsq_d_EditorManagerEventMap as EditorManagerEventMap, };
}
...
interface BaseEditorOptions {
    ...
    imagsq_file_types?: string;
    imagsq_replace_blob_uris?: boolean;
    imagsq_reuse_filename?: boolean;
    imagsq_upload_base_path?: string;
    imagsq_upload_credentials?: boolean;
    imagsq_upload_handler?: UploadHandler;
    imagsq_upload_url?: string;
    indent?: boolean;
    indent_after?: string;
    ...
    inline_boundarisq_selector?: string;
    inline_styles?: boolean;
    invalid_elements?: string;
    invalid_styles?: string | Record<string, string>;
    keep_styles?: boolean;
    ...
    paste_remove_stylsq_if_webkit?: boolean;
