<%@ Page Title="Cookies Policy | TamazGlobal" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cookies-policy.aspx.cs" Inherits="cookies_policy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link rel="canonical" href="<%= Request.Url.AbsoluteUri.ToLower() %>" />
    <meta name="description" content="The cookie automatically runs out when the individual closes their browser. Even if site visitors reject the cookie, they can still access our internet site." />
    ...
    <section class="relative bg-bg-light py-0 overflow-hidden">
        <div class="py-10 bg-bg-light">
            <div class="max-w-7xl mx-auto px-4 text-center">
                ...
                <!-- Title -->
                <h1 class="text-4xl md:text-5xl font-bold text-primary mb-4 tracking-tight">Cookies Policy
                </h1>
