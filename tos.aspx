<%@ Page Title="Terms & Conditions | TamazGlobal" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tos.aspx.cs" Inherits="terms_and_conditions" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link rel="canonical" href="<%= Request.Url.AbsoluteUri.ToLower() %>" />
    <meta name="description" content="All information displayed, transmitted, or carried on the Website is protected by copyright and other intellectual property laws." />
    ...
    <section class="relative bg-bg-light py-0 overflow-hidden">
        <div class="py-10 bg-bg-light">
            <div class="max-w-7xl mx-auto px-4 text-center">
                ...
                <!-- Title -->
                <h1 class="text-4xl md:text-5xl font-bold text-primary mb-4 tracking-tight">Terms & Conditions
                </h1>
