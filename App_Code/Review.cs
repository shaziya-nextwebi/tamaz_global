...
public class Review
{
    ...
    public static int InsertReview(SqlConnection con, Review rev)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateReview(SqlConnection con, Review rev)
    {
        int result = 0;
        try
        {
    ...
    public static List<Review> GetAllReviews(SqlConnection con)
    {
    ...
    public static List<Review> GetReviewById(SqlConnection con, int id)
    {
        List<Review> list = new List<Review>();
        try
        {
    ...
    public static int DeleteReview(SqlConnection con, Review rev)
    {
