<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="payment-success.aspx.cs" Inherits="payment_success" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="relative max-w-2xl mx-auto text-center">
            ...
            <p class="fade-in-up delay-3 text-black max-w-md mx-auto mb-10 leading-relaxed">
              Thank you for choosing Thamaz Global—your order is now being processed.
            </p>
